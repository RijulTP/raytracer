...
std::cout<<"Hello";
	...
	float boxSize = 0.50;
	vec3 boxOrientation(boxSize, 0,0);
	...
	// Translate the boxes
	translate *box2Translated = new translate(&box2, vec3(.9,.9,0));
	translate *box3Translated = new translate(&box3, vec3(0,-2,0));
	translate *box4Translated = new translate(&box4, boxOrientation*3);
	translate *box5Translated = new translate(&box5, boxOrientation*4);
	translate *box6Translated = new translate(&box6, boxOrientation*5);

	// Rotate the boxes
	rotate_z *box2Rotated = new rotate_z(box2Translated, 60);
	rotate_z *box3Rotated = new rotate_z(box3Translated, 0);
	rotate_z *box4Rotated = new rotate_z(box4Translated, 180);
	rotate_z *box5Rotated = new rotate_z(box5Translated, 240);
	rotate_z *box6Rotated = new rotate_z(box6Translated, 300);
	...
	for(int i=1;i<threadNum+1;i++){
		threads.push_back(std::thread([height,width, &world, &cam,ns,i,threadNum]() {
