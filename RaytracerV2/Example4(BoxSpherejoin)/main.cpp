...
std::cout<<"Hello";
	...
	std::cout<<"Hello";
	list[0] = new box(vec3(-0.75, 2.0, -0.5), vec3(1.25, 2.3, 0.25), new lambertian(vec3(0.2,0.2,0.2)));
	list[1] = new sphere(vec3(0,-100.5,-1),100,new lambertian(vec3(0.8,0.8,0.0)));
	list[2] = new sphere(vec3(1.25,2.2,-0.5),0.15,new lambertian(vec3(1.0,0.0,0.0)));
	list[3] = new sphere(vec3(-0.75,2.2,-0.5),0.15,new lambertian(vec3(1.0,0.0,0.0)));
	std::cout<<"Hello";
